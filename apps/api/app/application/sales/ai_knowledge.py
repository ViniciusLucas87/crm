...
class KnowledgeBaseArchitecture:
    ...
    PLAYBOOK: list[dict[str, str]] = [
        ...
        {"category": "technical", "title": "Internal meeting intelligence roadmap", "summary": "ScribaDev is the approved architectural reference for a private PNS meeting capture and CRM notes workflow.", "content": "Use https://github.com/allanrmartins/ScribaDev as a pinned upstream reference after a security review. Keep microphone and system-audio recording plus Whisper transcription local by default. Require visible recording status, operator confirmation of consent, meeting-level discard, human review before CRM upload, short-lived scoped credentials, audit logs, and retention controls. Import only approved structured notes into the CRM during the first release. Preserve the ScribaDev MIT copyright and permission notice for copied or substantial portions and review its third-party licenses."},
