...
import { Building2, CircleUserRound, LayoutDashboard, LogOut, Menu, Sparkles, X, Users, Target, ClipboardList, ClipboardCheck, FolderKanban, FileText, FileCheck, BarChart3, Settings, Sun, Search, CalendarCheck2, Mail, Lightbulb, BookOpen, Phone, PhoneCall, Radar, FlaskConical, Signal, Bookmark, Send, Download, TrendingUp, Brain, Shield, Activity, PackageCheck, MessageCircle, Linkedin, Factory, Video } from "lucide-react";
...
const navigation: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "LinkedIn Opportunities", icon: Linkedin, href: "/leads/linkedin" as Route, active: true },
      { label: "TikTok Opportunities", icon: Video, href: "/leads/tiktok" as Route, active: true },
